...
if(__name__=='__main__'):
    if not os.path.exists(tfrecord_train):
        ...
        img_train,img_test,label_train,label_test = train_test_split(images_list,labels_list,test_size = 0.1, random_state=random.randint(0,100))
        convert_to_tfrecord(img_train,label_train,'./','train')
        convert_to_tfrecord(img_test,label_test,'./','test')
        print('end')
